...
# To answer this question, we first need to filter the data for "Average" (not
# "Median") family wealth. Then we need to make a new dataframe from race_wealth
# with the average family wealth per year for all races
...
# Use the race_wealth dataframe and filter for only "Average" wealth
# `avg_race_wealth`
...
# Finally, let's make a line plot of the percentage of homeowners for racial
# categories over time, and color by race
